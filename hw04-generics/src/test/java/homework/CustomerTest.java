...
class CustomerTest {
    ...
    @Test
    @DisplayName("Объект Customer как ключ в карте (Test2)")
    ...
    @Test
    @DisplayName("Сортировка по полю score, итерация по возрастанию (Test3)")
    ...
    @Test
    @DisplayName("Модификация коллекции (Test4)")
    void mutationTest() {
        //given
        Customer customer1 = new Customer(1, "Ivan", 233);
        Customer customer2 = new Customer(2, "Petr", 11);
    ...
    @Test
    @DisplayName("Возвращание в обратном порядке (Test5)")
